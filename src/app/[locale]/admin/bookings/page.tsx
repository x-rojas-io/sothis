...
import { ChevronLeftIcon, ChevronRightIcon, CalendarDaysIcon, ListBulletIcon, ArrowLeftIcon, LockClosedIcon, CheckCircleIcon } from '@heroicons/react/24/solid';
...
export default function MasterCalendarPage() {
    ...
    // --- Helpers ---
    const getSlotsForDate = (date: Date) => slots.filter(s => isSameDay(parseISO(s.date), date));
    ...
    if (loading) return <AdminLayout><div className="text-center py-12">Loading Master Calendar...</div></AdminLayout>;
